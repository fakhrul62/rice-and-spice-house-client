...
const AboutSection = () => {
  return (
    <div className="w-10/12 mx-auto my-32 rounded-lg overflow-hidden">
      <Parallax
      bgImage="https://i.ibb.co.com/zhV77MK/popular-items.jpg"
      strength={200}
    >
      <div>
        <div className=" bg-cover bg-center p-20">
          <div className="bg-white p-16 space-y-3 rounded-lg">
            ...
            <p className="text-center text-zinc-600">
              ...
              touch of artistry. From delicate sushi to bold curries, each dish
              is a harmonious blend of taste and sophistication. Step into a
              world of fine dining that’s as vibrant as it is unforgettable.
            </p>
          </div>
        </div>
      </div>
