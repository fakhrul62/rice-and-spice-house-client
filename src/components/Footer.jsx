...
const Footer = () => {
  return (
    <footer class="text-gray-600 body-font border-t border-gray-200">
      <div class="w-10/12 mx-auto px-5 py-24 flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        ...
        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                <a class="text-gray-600 hover:text-gray-800">Chef's Vision</a>
              </li>
              <li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                <a class="text-gray-600 hover:text-gray-800">Reservations</a>
              </li>
              <li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a class="text-gray-600 hover:text-gray-800">Private Dining</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Catering Services</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Gift Cards</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">Loyalty Program</a>
              </li>
            </nav>
          </div>
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div class="bg-gray-100">
        <div class="w-10/12 mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
